    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-12 py-10">
        ...
        <div className="relative flex flex-wrap gap-6 justify-center items-center max-w-full">
          {/* Star Rating */}
          <div className="hidden lg:flex absolute lg:top-1/3 xl:top-0 lg:left-0 xl:left-1/2 transform -translate-x-1/2 -translate-y-full bg-white rounded-full px-3 py-1 items-center gap-1 shadow-lg z-20">
            {[...Array(5)].map((_, i) => (
              <FaStar
                key={i}
          ...
          <div className="relative w-64 sm:w-72 xl:w-80 shadow-lg rounded-xl overflow-hidden">
            ...
            <img
              src={loveSvg}
              alt="Love Icon"
              className="absolute lg:top-[42%] xl:top-1/2 lg:left-0 xl:-left-8 w-10 sm:w-14 rotate-[-15deg] drop-shadow-lg hidden lg:block"
            />
          </div>
